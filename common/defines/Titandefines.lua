...
NDefines.NMilitary.GARRISON_SIZE = 2500
NDefines.NMilitary.FORTRESS_COST = 0.25
NDefines.NMilitary.SIEGE_FORCE_NEEDED_MULTIPLIER = 0.4
NDefines.NMilitary.ASSAULT_WIDTH_LIMIT = 3
...
NDefines.NMilitary.LAND_FORCELIMIT_EXTRA_COST_FACTOR = 2.25
